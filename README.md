...
Midway through building the lab, VLAN tagging for Targets (`vmbr2`) and Attacker (`vmbr3`) zones ran into persistent issues, and the pragmatic fix was migrating those zones to private, host-internal Proxmox bridges instead. Rather than treat this as a footnote or hide it, it's documented here as a real architectural decision. This is a kind of workaround-under-constraint that happens in production environments too, not just labs.
